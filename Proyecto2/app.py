...
class prinicipal:
    ...
    def principio(self):
        ...
        ####
        lex.analizar(res)
        sint = Sintactico.AnalizadorSintactico(lex.listaTokens)
        sint.analizar()
        res = ok.callme()
    ...
    def INICIO(self):
        ...
        DIVISION = '*----------------------------------------------------------------------------*'
        btn_errores = Button(self.window,text='Reporte de Errores',command='',bg='#f39c12',width=16,borderwidth=4,relief='raised',foreground='black',font='Arial 11 bold',height=1,).place(x=680,y=36)
        btn_limpiar1 = Button(self.window,text='Clean log de Errores',command='',bg='#f39c12',width=16,borderwidth=4,relief='raised',foreground='black',font='Arial 11 bold',height=1).place(x=680,y=83)
        btn_tokens = Button(self.window,text='Reporte de Tokens',command='reports',bg='#f39c12',width=16,borderwidth=4,relief='raised',foreground='black',font='Arial 11 bold',height=1).place(x=680,y=130)
        btn_limpiar2 = Button(self.window,text='Clean log de Tokens',command='reports',bg='#f39c12',width=16,borderwidth=4,relief='raised',foreground='black',font='Arial 11 bold',height=1).place(x=680,y=177)
        btn_manualU = Button(self.window,text='Manual de Usuario',command='reports',bg='#f39c12',width=16,borderwidth=4,relief='raised',foreground='black',font='Arial 11 bold',height=1).place(x=680,y=224)
        btn_manualT = Button(self.window,text='Manual Tecnico',command='reports',bg='#f39c12',width=16,borderwidth=4,relief='raised',foreground='black',font='Arial 11 bold',height=1).place(x=680,y=271)
        ...
        btnLimp = Button(self.window, text="Limpiar texto",bg='blue',borderwidth=5,fg='white',font='Arial 10 bold',command='clean',height=1,width=10)
